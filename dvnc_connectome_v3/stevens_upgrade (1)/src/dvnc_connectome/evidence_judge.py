...
THEORY-EXPERIENCE DIALECTIC (LMM_005):
For each of the top 3 evidence sources, answer:
  Is the current state of knowledge blocked by THEORY without empirical grounding,
  or by EMPIRICAL OBSERVATION without theoretical framework?
  Which direction should the next experiment push?

[S1]: [Theory-blocked / Empirically-blocked / Balanced] — [one sentence on what
      experiment or theoretical advance would unblock progress]
[S2]: [Theory-blocked / Empirically-blocked / Balanced] — [one sentence]
[S3]: [Theory-blocked / Empirically-blocked / Balanced] — [one sentence]
